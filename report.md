...
### Терентьев
1. Разработал парсер расписания по станции
2. Разработал парсер расписания между станциями
3. Проводил code-review
4. Громко ругался на Яндекс
...
Освоили работу с git, vim.
В ходе работы осваивался язык PHP, работали с Яндекс.API.
В момент появления конфликтов, учились оперативно их разрешать.
Научились проводить code-review.
